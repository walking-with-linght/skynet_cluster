...
-- Dependencies
local utils     = require ("astar_lib2.utils")
local heap      = require ("astar_lib2.heap")
local Heuristic = require ("astar_lib2.heuristics")
local Grid      = require ("astar_lib2.grid")
local path      = require ("astar_lib2.path")
...
-- @finder Finders
local Finders = {
  ['BFS']       = require ("astar_lib2.bfs"),
  ['DFS']       = require ("astar_lib2.dfs"),
  ['ASTAR']     = require ("astar_lib2.astar"),
  ['THETASTAR'] = require ("astar_lib2.thetastar"),
  ['LAZYTHETASTAR'] = require ("astar_lib2.lazyThetAStar"),
  ['JPS']       = require ("astar_lib2.jpsprune")
}
...
function PathFinder:getPath(startX, startY, endX, endY)
  ...
  --
  if not self._grid:isWalkable(endX, endY, 0) then
    return
  end
  --
